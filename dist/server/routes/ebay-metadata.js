...
import { CONDITION_DESCRIPTIONS, EBAY_CONDITION_GRADE_MAP, } from '../../config/condition-descriptions.js';
...
router.get('/api/ebay/categories', (_req, res) => {
    try {
...
router.get('/api/ebay/condition-descriptions', (_req, res) => {
    try {
        res.json({
